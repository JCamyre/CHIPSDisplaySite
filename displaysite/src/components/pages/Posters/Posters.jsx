    ...
    <Container className='content' maxWidth='lg'>
        ...
        <Box style={{justiyContent: 'center', backgroundColor: '#fff', margin: 'auto', borderRadius: '10px', marginTop: '20px', padding: '20px', boxShadow: '0 10px 8px -4px rgba(0, 0, 0, 0.1)'}}>
          ...
          <Carousel width={'100%'} height={'50%'} centerMode={true} transitionTime={700} centerSlidePercentage={55} showIndicators={false} showStatus={false} infiniteLoop={true} showThumbs={false} stopOnHover={true} >
            <div>
              <Document onLoadError={console.error} file={'/posters/instructions.pdf'} error='Trying to find the poster, sorry!'>
                <Page pageNumber={1} />
              </Document>
              <p className='legend'>PDF #1</p>
            </div>
            <div>
              <Document onLoadError={console.error} file={'/posters/Joseph_S_Camyre_Resume.docx.pdf'} error='Trying to find the poster, sorry!'>
                <Page pageNumber={1} />
              </Document>
              <p className='legend'>PDF #2</p>
            </div>        
            <div>
              <Document onLoadError={console.error} file={'/posters/Joseph_S_Camyre_Resume.pdf'} error='Trying to find the poster, sorry!'>
                <Page pageNumber={1} />
              </Document>
